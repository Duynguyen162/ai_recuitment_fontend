        ...
        <div className={styles.formMain}>
          <section className={styles.card}>
            <div className={styles.sectionHeader}>
              ...
              <p>
                Điền tiêu đề, bối cảnh công việc và nhóm kỹ năng chính theo cách
                dùng để ứng viên quét nhanh trong vài giây.
              </p>
            </div>
          ...
          <section className={styles.card}>
            <div className={styles.sectionHeader}>
              ...
              <p>
                Các trường được rải đều trên giao diện để người dùng không phải
                thao tác dồn về một phía màn hình.
              </p>
            </div>
        ...
        <aside className={styles.sidebar}>
          <div className={styles.card}>
            ...
            <div className={styles.hintList}>
              <div className={styles.hintItem}>
                <MapPin size={16} />
                Ghi rõ hình thức làm việc: onsite, hybrid hoặc remote.
              </div>
              <div className={styles.hintItem}>
                <CalendarClock size={16} />
                Đặt hạn ứng tuyển hợp lý để job không hết hạn sớm.
              </div>
              <div className={styles.hintItem}>
                <FileText size={16} />
                Phần mô tả và yêu cầu nên tách ý rõ ràng để dễ đọc.
              </div>
            </div>
          </div>
          ...
          <div className={styles.card}>
            ...
            <div className={styles.summaryList}>
              ...
              <div className={styles.summaryItem}>
                <span>Trạng thái sẽ lưu</span>
                <strong>
                  {submitIntent === "publish" ? "Chuẩn bị đăng" : "Lưu nháp"}
                </strong>
              </div>
            </div>
          </div>
